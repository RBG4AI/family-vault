    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center">
          ...
          <h1 className="font-display text-3xl text-white">{vault?.name || 'Vault'}</h1>
          <p className="text-white/45 mt-2">
            {vault?.isLegacy ? 'Unlock to encrypt this vault and delete the old plaintext copy.' : 'Enter the master password for this vault.'}
          </p>
        </div>
